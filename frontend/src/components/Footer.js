      ...
      >
        <div className=" flex items-center sm:justify-between sm:gap-0 gap-5 sm:flex-row flex-col justify-center">
          <div className=" flex items-center justify-center sm:flex-row flex-col gap-2">
            <p className="sm:text-sm font-bold gradient-text">
              Memories <i className="ri-sparkling-2-fill gradient-text"></i>
            </p>
          ...
          <div className=" flex items-center justify-center gap-5 text-xl">
            <a href="#" target="_blank">
              <FaInstagram className="hover:text-rose-600 transition-all duration-200" />
            </a>
            <a href="https://x.com/AryaKS01" target="_blank">
              <FaXTwitter className=" dark:hover:text-gray-50 hover:text-black transition-all duration-200" />
            </a>
            <a
            ...
            <a href="https://github.com/AryaKS01" target="_blank">
              <FaGithub className=" dark:hover:text-gray-50 hover:text-black transition-all duration-200" />
            </a>
          </div>
        </div>
        ...
        <div className=" flex items-center justify-center text-md">
          <p>Developed by</p> <Divider type="vertical" className=" h-5" />{" "}
          <a
            className=" font-semibold hover:text-black dark:hover:text-white dark:text-white dark:text-opacity-80 transition-all duration-200"
